...
class PegawaiWithTim {
  ...
  factory PegawaiWithTim.fromJson(Map<String, dynamic> map) {
    return PegawaiWithTim(
      uuid: map['uuid'] != null ? map['uuid'] as String : null,
      fullname: map['fullname'] != null ? map['fullname'] as String : null,
      fullname_with_title: map['fullname_with_title'] != null ? map['fullname_with_title'] as String : null,
  ...
  factory PegawaiWithTim.fromDb(Map<String, dynamic> map) {
    return PegawaiWithTim(
      uuid: map['uuid'] != null ? map['uuid'] as String : null,
      fullname: map['fullname'] != null ? map['fullname'] as String : null,
      fullname_with_title: map['fullname_with_title'] != null ? map['fullname_with_title'] as String : null,
  ...
  factory PegawaiWithTim.fromDbPrefix(Map<String, dynamic> map, String prefix) {
    return PegawaiWithTim(
      uuid: map['${prefix}_uuid'] != null ? map['${prefix}_uuid'] as String : null,
      fullname: map['${prefix}_fullname'] != null ? map['${prefix}_fullname'] as String : null,
      fullname_with_title: map['${prefix}_fullname_with_title'] != null ? map['${prefix}_fullname_with_title'] as String : null,
  ...
  @override
  String toString() {
    return 'PegawaiWithTim(uuid: $uuid, fullname: $fullname, fullname_with_title: $fullname_with_title, nickname: $nickname, nip: $nip, old_nip: $old_nip, phone_number: $phone_number, username: $username, status_pegawai: $status_pegawai, jabatan: $jabatan, tim: $tim)';
  }

  @override
  bool operator ==(covariant PegawaiWithTim other) {
    if (identical(this, other)) return true;
  ...
  int get hashCode {
    return uuid.hashCode ^
      fullname.hashCode ^
      fullname_with_title.hashCode ^
      nickname.hashCode ^
      nip.hashCode ^
      old_nip.hashCode ^
      phone_number.hashCode ^
      username.hashCode ^
      status_pegawai.hashCode ^
      jabatan.hashCode ^
      tim.hashCode;
  }
}
